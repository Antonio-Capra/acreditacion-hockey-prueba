          ...
          >
            ...
            >
              <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800">
                  Acreditaciones a registrar: {formData.acreditados.length} de {selectedArea?.cupos} disponibles.
                </p>
              </div>
              {formData.acreditados.length < (selectedArea?.cupos || 1) && (
                <div className="mb-4">
                  <button
                    type="button"
              ...
              <div className="space-y-6">
                {formData.acreditados.map((acreditado, index) => (
                  <div
                    key={index}
                    className="border-2 border-gray-200 rounded-lg p-4 space-y-4 bg-gray-50 relative"
                  >
                    {formData.acreditados.length > 1 && (
                      <button
                        type="button"
                        onClick={() => handleRemoveAcreditado(index)}
