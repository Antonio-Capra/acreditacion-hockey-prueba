...
export default function AdminLogin() {
  ...
  return (
    <main className="min-h-screen w-full bg-gradient-to-br from-[#a10d79] via-[#3d2362] to-[#7518ef] flex items-center justify-center px-4 py-10 relative overflow-hidden">
      {/* Decoración de fondo */}
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-10 backdrop-blur-xl border border-purple-100">
          ...
          <form onSubmit={login} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-xl bg-gradient-to-r from-[#a10d79] via-[#3d2362] to-[#7518ef] hover:shadow-lg text-white font-semibold px-4 py-3.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98]"
            >
              {loading ? (
                <>
