      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] md:overflow-hidden shadow-2xl flex flex-col">
        ...
        <div className="px-6 py-4 flex-1 min-h-0 flex flex-col">
          ...
          <div
            ...
            className="max-h-60 md:max-h-80 overflow-y-auto scrollbar-thin scrollbar-thumb-black/30 scrollbar-track-gray-100 scrollbar-thumb-rounded-full hover:scrollbar-thumb-black/50 transition-colors pb-28 md:pb-0"
          >
            <div className="space-y-4 text-xl md:text-2xl text-gray-700 pr-2">
              ...
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm">
                <div className="space-y-3">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Colo-Colo no aceptará solicitudes con más inscritos que el cupo asignado según corresponda a su tipo de medio.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm">
                <div className="space-y-3">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Solicitudes de excepciones a los cupos y/o disponibilidad de espacios de estacionamiento (limitados), deben ser consultadas al área de comunicaciones de Colo-Colo, con la debida anterioridad y por los canales formales (correo palarcon@colocolo.cl).
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex gap-3 mt-6 md:static fixed left-0 right-0 bottom-0 bg-white md:bg-transparent p-4 md:p-0 z-20 border-t md:border-0">
            <button
              ...
              className={`flex-1 px-6 py-4 font-semibold rounded-xl transition-all duration-300 text-lg ${
                canAccept
                  ? 'bg-gradient-to-r from-black to-gray-800 hover:from-gray-800 hover:to-black text-white shadow-lg hover:shadow-xl active:scale-95'
