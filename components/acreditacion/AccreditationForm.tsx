  ...
  return (
    <section className="bg-white/95 backdrop-blur-sm rounded-2xl border border-white/30 p-6 shadow-2xl">
      <div className="flex items-center justify-between mb-4">
        ...
        <button className="text-sm text-[#1e5799] hover:text-[#2989d8] font-medium underline" onClick={onCancel}>
          Cambiar área
        </button>
      </div>
      ...
      <form onSubmit={manejarSubmit} className="grid grid-cols-1 gap-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              className="w-full rounded-xl border border-gray-300 px-3 py-2 focus:border-[#1e5799] focus:ring-2 focus:ring-[#1e5799]/20 transition-all"
              value={datos.nombre}
        ...
        <div className="flex items-start gap-2">
          <input
            id="acepta-tyc"
            type="checkbox"
            className="mt-1 h-4 w-4 rounded border-gray-300 text-[#1e5799] focus:ring-[#1e5799]"
            checked={aceptaTyC}
          ...
          <label htmlFor="acepta-tyc" className="text-sm text-gray-700">
            ...
            <a
              ...
              className="text-[#1e5799] hover:text-[#2989d8] underline font-medium"
            >
              términos y condiciones
            </a>.
          </label>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="rounded-xl bg-gradient-to-r from-[#1e5799] to-[#7db9e8] hover:from-[#2989d8] hover:to-[#7db9e8] text-white font-semibold px-6 py-2.5 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 hover:scale-105 shadow-lg flex items-center justify-center gap-2"
          >
            {cargando ? (
              <>
          ...
          <button 
            ...
            onClick={onCancel} 
            disabled={cargando}
            className="rounded-xl bg-white border-2 border-[#1e5799]/30 text-[#1e5799] hover:bg-[#a10d79]/5 font-medium px-6 py-2.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Volver
          </button>
        </div>
